...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-md p-4  shadow sm:p-8 bg-white bg-opacity-10 text-gray-100 mx-auto sm:rounded-md sm:mt-5 md:mt-10 mb-10">
            ...
            <p className="text-sm text-center text-gray-400">Don't have account? <Link to='/signup' rel="noopener noreferrer" className="focus:underline hover:underline">Sign up here</Link>
            </p>
            <div className="my-6 space-y-4">
                ...
                <button onClick={handleGithubLogIn} aria-label="Login with GitHub" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 focus:ring-violet-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">

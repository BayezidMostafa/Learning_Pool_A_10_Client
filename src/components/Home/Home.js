            ...
            <div style={{ boxShadow: '0px 2px 20px gray' }} className="dark:bg-slate-100">
                <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-900">
                    ...
                    <div className="flex flex-wrap justify-center">
                        <Link to='/courses'><button type="button" className="px-8 py-3 m-2 text-lg font-semibold rounded dark:bg-gray-800 dark:text-gray-50 hover:bg-gray-700">Get started</button></Link>
